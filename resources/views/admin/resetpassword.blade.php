    ...
    <form class="login-form" action="{{ URL::to('/admin/login/action') }}" method="post">
      ...
      <div class="row">
        <div class="input-field sm col s12" style="text-align: center;">
          ...
          <button type="submit" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s6" style="float: none !important;">Reset Password</button>
        </div>
      </div>
      <!--<div class="row">

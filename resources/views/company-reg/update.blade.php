                      ...
                      <div class="card-header">
                        ...
                        <div class="row">
                          ...
                          <div class=" col-sm-12 col-md-3" style="width: 25%;">
                            ...
                            <div>
                              <img src="/public/asset/images/btn_loader.gif" id="po_search_loader1" class="input_loader po_search_loader" style="display: none; position: unset;width: 25px;height: 25px;text-align: left;float: left;margin-left: -20px;margin-right: 10px;margin-top: 3px;">

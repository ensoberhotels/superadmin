    ...
    <aside class="sidenav-main nav-expanded nav-lock nav-collapsible sidenav-light sidenav-active-square">
      ...
      <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out" data-menu="menu-navigation" data-collapsible="menu-accordion">
		...
		<li class="navigation-header"><a class="navigation-header-text">Applications</a><i class="navigation-header-icon material-icons">more_horiz</i>
				...
				<li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="{{URL::to('/company-master')}}"><i class="material-icons">store</i><span class="menu-title" data-i18n="">Company Master</span></a>
          <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="{{URL::to('/module-master')}}"><i class="material-icons">store</i><span class="menu-title" data-i18n="">Module Master</span></a>
            ...
            <li class="bold"><a class="collapsible-header waves-effect waves-cyan " href="{{URL::to('/company-privilege')}}"><i class="material-icons">menu</i><span class="menu-title" data-i18n="">Company Privilege</span></a>

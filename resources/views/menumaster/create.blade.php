                      ...
                      <div class="card-header">
                        ...
                        <div class="row">
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                             ...
                             <input type="text" name="name" id="name" oninput="fileName()" class="form-control"> 
                            </div>
                          </div>
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                             ...
                             <input type="text" name="f_icon" id="f_icon" class="form-control"> 
                            </div>
                          </div>
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                          ...
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                             ...
                             <input type="text" name="t_code" id="t_code" class="form-control"> 
                            </div>
                          </div>
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                        ...
                        <div class="row">
                          <div class=" col-sm-12 col-md-3">
                            ...
                            <div>
                              <img src="{{URL::asset('/asset/images/btn_loader.gif')}}" id="po_search_loader1" class="input_loader po_search_loader" style="display: none; position: unset;width: 25px;height: 25px;text-align: left;float: left;margin-left: -20px;margin-right: 10px;margin-top: 3px;">

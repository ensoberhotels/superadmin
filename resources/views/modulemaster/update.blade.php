                      ...
                      <div class="card-header">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                             ...
                             <input type="text" value="{{$record->description}}" name="company_desc" id="company_desc" class="form-control"> 
                            </div>
                          </div>
                          <div class="col-sm-12 col-md-3">
                            <div class="form-group">
                             ...
                             <select name="company_type" id="company_type" class="form-control"> 
                                ...
                                <option value="HOTEL" @if($record->description =='HOTEL') selected @endif>HOTEL</option>
                                <option value="TRANSPORT" @if($record->description =='TRANSPORT') selected @endif>TRANSPORT</option>
                                <option value="EVENT" @if($record->description =='EVENT') selected @endif>EVENT</option>
                             </select>
                            </div>
                        ...
                        <div class="row">
                          ...
                          <div class=" col-sm-12 col-md-3" style="width: 25%;">
                            <button class="btn waves-effect waves-light left" type="button" onclick="updateData()" name="action" id="add_hotel">Update
                              <i class="material-icons right">send</i>
                            </button>
                            <a href="{{URL::to('/company-master')}}" class="btn waves-effect waves-dark right" style="background-color: #bfb32b;color: #fff;">Back</a>
                          </div>
                        </div>
            </form>
                </div>
